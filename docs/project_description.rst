...
.. code:: python
  ...
  class Song(models.Model):
      song_hash = models.CharField(max_length = 40, unique = True, db_index = True)
  ...
  class Instance(models.Model):
      ...
      instance_hash = models.CharField(max_length = 40, unique = True, db_index = True)
      instance_text = models.TextField()  # length limit? (SlugField defaults to 50, so ???)
  ...
  class Title(models.Model):
      ...
      title_text = models.CharField(unique = True, db_index = True)  # length limit?
  ...
  class Collection(models.Model):
      ...
      collection_text = models.URLField(unique = True)  # 200 char limit
